			...
			columns: [{
                ...
                template: function (row) {
                    ...
                    result = result + '\
						...
						<a hidden="hidden" href="/manage/order/'+ orderId + '/entitylist/' + listId +'/entity/'+ entityId +'/documentpackage/' +row.id +'/delete" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Удалить">\
