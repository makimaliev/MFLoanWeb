		...
		var datatable = $('#RLsTable').mDatatable({
			...
			columns: [{
                ...
                template: function (row) {
                    ...
                    result = result + '\
						<a sec:authorize="hasAnyAuthority(ADMIN,PERM_UPDATE_RECONSTRUCTEDLIST)" href="/manage/debtor/'+ debtorId + '/loan/'+ loanId + '/reconstructedlist/' + row.id +'/save" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Редактировать">\
