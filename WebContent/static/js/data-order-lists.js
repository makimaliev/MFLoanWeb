			...
			columns: [{
                ...
                template: function (row) {
                    ...
                    result = result + '\
						...
						<a hidden="hidden" href="/manage/order/'+ orderId + '/entitylist/' + row.id +'/delete" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Удалить">\
