	...
	var mainTableInit = function () {
		...
		var datatable = $('#itemsTable').mDatatable({
			...
			columns: [{
                ...
                template: function (row) {
                    return '\
						<a href="/manage/debtor/'+ debtorId + '/collateralagreement/'+ agreementId + '/collateralitem/' + row.id +'/save" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Редактировать">\
							<i class="la la-edit"></i>\
						</a>\
						<a href="/manage/debtor/'+ debtorId + '/collateralagreement/'+ agreementId + '/collateralitem/' + row.id +'/delete" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Удалить">\
