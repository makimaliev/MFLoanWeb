			...
			columns: [{
                ...
                template: function (row) {
                    return '\
						...
						<a href="/manage/debtor/'+ debtorId + '/collateralagreement/'+ agreementId + '/collateralitem/'+ itemId + '/arrestfree/' + row.id +'/delete" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Удалить">\
