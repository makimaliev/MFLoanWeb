...
INSERT INTO `mfloan`.`cat_document_subtype` (`version`, `name`, `internalName`, documentType_id) VALUES ('1', 'Служебная записка', 'zapiska', 1);
INSERT INTO `mfloan`.`cat_document_subtype` (`version`, `name`, `internalName`, documentType_id) VALUES ('1', 'Заявление', 'zayavleniye', 1);
INSERT INTO `mfloan`.`cat_document_subtype` (`version`, `name`, `internalName`, documentType_id) VALUES ('1', 'Приказ', 'prikaz', 1);
INSERT INTO `mfloan`.`cat_document_subtype` (`version`, `name`, `internalName`, documentType_id) VALUES ('1', 'Договор', 'dogovor', 2);
INSERT INTO `mfloan`.`cat_document_subtype` (`version`, `name`, `internalName`, documentType_id) VALUES ('1', 'Протокол', 'protocol', 3);

INSERT INTO `mfloan`.`cat_document_status` (`version`, `name`, `internalName`) VALUES (1,'Создан','create');
INSERT INTO `mfloan`.`cat_document_status` (`version`, `name`, `internalName`) VALUES (1,'На утверждении','request');
...
INSERT INTO `mfloan`.`cat_document_status` (`version`, `name`, `internalName`) VALUES (1,'Архивирован','archive');
